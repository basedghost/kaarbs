...
install_dep () {
	...
	sudo pacman -S git nano rsync noto-fonts noto-fonts-cjk noto-fonts-emoji terminus-font aria2 pacman-contrib arandr nvidia-settings ufw neofetch qt5-base qt5-svg qt5-quickcontrols qt5-quickcontrols2 qt5-graphicaleffects zip unzip p7zip ntfs-3g logrotate;
